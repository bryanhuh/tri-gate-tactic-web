...
- **Theme Harmonization:** Updated `CharacterSelection` and `DeckBuilder` UI to use a cohesive Yellow/Gold theme, matching the main Showcase style and replacing the previous Blue/Cyan aesthetic.
