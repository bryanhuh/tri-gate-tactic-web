...
import { Trash2, Play, ChevronLeft, Search as SearchIcon, Shield, Zap, Heart } from 'lucide-react';
            ...
            <div className="w-[450px] flex flex-col bg-gray-900/60 backdrop-blur-xl border-l border-white/10 shadow-2xl z-20 relative">
                            ...
                            >
                                ...
                                <div className="flex-1 z-10 min-w-0">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <div className={`text-xs font-black px-1.5 py-0.5 rounded border ${char.tier.startsWith('S') ? 'bg-yellow-500/20 border-yellow-500 text-yellow-500' :
                ...
                <div className="p-6 border-t border-white/10 bg-black/40 backdrop-blur-md">
                    ...
                    <button
                        ...
                        className={`w-full py-5 rounded-lg font-black italic tracking-wider text-lg flex items-center justify-center gap-3 transition-all relative overflow-hidden group ${deck.length === 5
