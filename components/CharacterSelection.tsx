...
import { Info, RefreshCw, Play, Sparkles } from 'lucide-react';
    ...
    <div className="flex flex-col items-center justify-center min-h-screen relative overflow-hidden bg-black font-sans">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1">
                  {['S++', 'S+', 'S', 'A+', 'A', 'B', 'C', 'D'].map((tier) => (
                    <span key={tier} className={`px-2 py-1 rounded text-[10px] font-mono font-bold border ${tier.startsWith('S') ? 'border-yellow-500/50 text-yellow-500 bg-yellow-500/10' :
      ...
      >
        <button
          ...
          className={`group relative px-12 py-5 font-black italic text-xl tracking-wider rounded-lg overflow-hidden transition-all duration-300 ${!allCharactersSelected || isFetchingDeck
